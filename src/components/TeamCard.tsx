  ...
  return (
    <div className="bg-white h-max rounded-lg my-5 lg:p-6 p-2">
      <div>
        ...
        <div className="">
          <Card name="John Smith" des="Designation here" link={p1} />
          <Card name="Elina Williams" des="Designation here" link={p2} />
          <Card name="John Smith" des="Designation here" link={p3} />
        </div>
      </div>
    </div>
  );
